...
export const getFrequencyHeatmap = async () => {
  const { data, status } = await axios.get<FrequencyHeatmap>(
    BASE_URL + "frequency/heatmap",
    {
      params: {
...
export const getFrequencyStudentMean = async () => {
  const { data, status } = await axios.get<FrequencyStudentMean[]>(
    BASE_URL + "frequency/student_mean",
    {
      params: {
        token: localStorage.getItem("userToken"),
        class_code: localStorage.getItem("classCode"),
...
export const getFrequencyWeekMean = async () => {
  const { data, status } = await axios.get<FrequencyWeekMean[]>(
    BASE_URL + "frequency/week_mean",
    {
      params: {
        token: localStorage.getItem("userToken"),
        class_code: localStorage.getItem("classCode"),
